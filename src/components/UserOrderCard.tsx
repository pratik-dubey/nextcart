...
export default function UserOrderCard({ order }: { order: IOrder }) {
    ...
    return <motion.div
        ...
        <div className='p-5 space-y-4'>
            ...
            {order.status != "delivered" && order.assignedDeliveryBoy && <>
            ...
            <div className='border-t border-gray-200 pt-3'>
                <button className="w-full text-gray-700 hover:text-green-700 flex justify-between items-center text-em font-medium" onClick={() => setExpanded(prev => !prev)}>
